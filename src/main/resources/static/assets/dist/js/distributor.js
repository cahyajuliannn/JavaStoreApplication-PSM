...
//                            },
    ...
    createByFilters: function() {
    	...
    	var alamatPT = $("#addressF").val();
    	var npwpPT = $("#npwpF").val();
    	
        $.ajax({
            url: '/api/ref-dist/filter/' + namaPT + '/' + alamatPT + '/' + npwpPT,
            method: 'get',
            contentType: 'application/json',
            success: function (res, status, xhr) {
                if (xhr.status == 200 || xhr.status == 201) {
                    $('#tableDistrib').DataTable({
                        ...
                        columns: [
                            ...
                            {title: "Alamat",data: "alamatPT"},
                            {title: "NPWP",data: "npwpPT"},
//                            {title: "Bank Rekening",data: "namaBank"},
//                            {title: "No. Rekening",data: "noRekening"},
//                            {title: "Atas Nama",data: "atasNama"},
                            {title: "Telepon",data: "noTelpPT"},
                            {title: "Email",data: "emailPT"},
                            {
                                title: "Action",
                                data: null,
                                render: function (data, type, row) {
